...
export function LocationIcon(props) {
  return <svg {...base} {...props} width={props.width || 14} height={props.height || 14}><path d="M12 21s7-6.6 7-11.5A7 7 0 0 0 5 9.5C5 14.4 12 21 12 21Z" /><circle cx="12" cy="9.5" r="2.5" /></svg>;
}
export function FilterIcon(props) {
  return <svg {...base} {...props} width={props.width || 18} height={props.height || 18}><path d="M4 5h16M7 12h10M10.5 19h3" /></svg>;
}
export function CoinIcon(props) {
  return <svg {...base} {...props} width={props.width || 14} height={props.height || 14}><circle cx="9" cy="9" r="6.5" /><circle cx="15" cy="15" r="6.5" /></svg>;
}
export function LogoutIcon(props) {
  return <svg {...base} {...props} width={props.width || 16} height={props.height || 16}><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4" /><path d="M16 17l5-5-5-5" /><path d="M21 12H9" /></svg>;
}
